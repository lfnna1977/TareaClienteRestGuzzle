...
$res = $client->request(
    'GET',
    'http://localhost:8077/api/countries',
    [ 'headers' => $headers ]
);
...
<main role="main" class="container">
  ...
  <div class="starter-template">
    ...
    <div class="text-right">
        <button type="button" class="btn btn-primary" type="submit" onclick="location.href='insertCountry.php'">Insert Country</button>
        <p></p>
    </div>
    <table class="table">
        ...
        ?>
            ...
            <td>[ <a href="viewCountry.php?id=<?php echo $value['id']; ?>">Ver</a> ] [ <a href="updateCountry.php?id=<?php echo $value['id']; ?>">Editar</a> ] [ <a href="deleteCountry.php?id=<?php echo $value['id']; ?>">Eliminar</a> ]</td>
            </tr>
        <?php 
        }
        ?>
