...
<h1>Insert Player</h1>
    <form action="insertedPlayer.php" method="post">
  <div class="form-group">
    <label for="inputCI">C.I.</label>
    <input type="text" class="form-control" id="inputCI" name="inputCI" placeholder="D.N.I.">    
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="inputAditionalData" name="inputAditionalData" placeholder="Aditional Data">
  </div>
  <div class="form-group">
    ...
    <select class="form-control" id="selectCountry" name="selectCountry">
      <?php
        foreach ($dataCountry as $keyCountry => $valueCountry) {
            # code...        
      ?>
      <option value="<?php echo $valueCountry['id']; ?>"><?php echo $valueCountry['name']; ?></option>
      <?php
        }
      ?>
    </select>
    ...
    <select class="form-control" id="selectClub" name="selectClub">
      <?php
        foreach ($dataClub as $keyClub => $valueClub) {
            # code...        
      ?>
      <option value="<?php echo $valueClub['id']; ?>"><?php echo $valueClub['name']; ?></option>
      <?php
        }
      ?>
    </select>
