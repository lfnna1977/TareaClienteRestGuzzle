...
if (isset($_POST['inputCode'])){    
    $client = new Client([
        'base_uri' => DIRECCION_BASE . '/api/countries/'.$_POST['inputID'],
        'timeout'  => 5.0,
    ]);
