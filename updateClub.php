...
$client = new Client([
    'base_uri' => DIRECCION_BASE . '/api/clubs/'.$_GET['id'],
    'timeout'  => 5.0,
]);
...
<h1>Update Club</h1>
    <form action="updatedClub.php" method="post">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="inputCity" name="inputCity" value="<?php echo $data['city']; ?>">
  </div>
  <div class="form-group">
    <label for="inputTelephone">Telephone</label>
    <input type="text" class="form-control" id="inputTelephone" name="inputTelephone" value="<?php echo $data['telephone']; ?>">
  </div>
  <div class="form-group">
    <label for="inputPartners">Partners</label>
    <input type="text" class="form-control" id="inputPartners" name="inputPartners" value="<?php echo $data['numSocios']; ?>">
  </div>
