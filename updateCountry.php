...
$client = new Client([
    'base_uri' => DIRECCION_BASE . '/api/countries/'.$_GET['id'],
    'timeout'  => 5.0,
]);
...
<h1>Update Country</h1>
    <form action="updatedCountry.php" method="post">
  <div class="form-group">
    <label for="inputCode">Code</label>
    <input type="text" class="form-control" id="inputCode" name="inputCode" aria-describedby="codeHelp" value="<?php echo $data['code']; ?>">
  </div>
  <div class="form-group">
    <label for="inputCountry">Country</label>
    <input type="text" class="form-control" id="inputCountry" name="inputCountry" value="<?php echo $data['name']; ?>">
