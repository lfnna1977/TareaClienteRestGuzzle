  ...
  <div class="starter-template">
    ...
    <table class="table">
        ...
        ?>
            ...
            <td><?php echo $value['aditionalData']; ?></td>
            <td><?php echo $value['country']['name']; ?></td>
            <td><?php echo $value['club']['name']; ?></td>
            <td>[ <a href="viewPlayer.php?id=<?php echo $value['id']; ?>">Ver</a> ] [ <a href="updatePlayer.php?id=<?php echo $value['id']; ?>">Editar</a> ] [ <a href="deletePlayer.php?id=<?php echo $value['id']; ?>">Eliminar</a> ]</td>
            </tr>
        <?php 
        }
        ?>
